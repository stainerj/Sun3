...
public class SunCalculatorPreviousVersion {
    ...
    public static double equatorialCoordinates() {
        ...
        System.out.println("SUN'S RIGHT ASCENSION ----  " + rASun + " SUN RA (ALTERNATIVE METHOD) ---- " + rASunAlternativeMethod);
        System.out.println("SUN'S DECLINATION -------- " + decSun + " SUN DEC (ALTERNATIVE METHOD) ---- " + decSunAlternativeMethod);
        return rASun;
        //are alternative method values more accurate?
    }
